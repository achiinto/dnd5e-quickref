data_action = [
    ...
    },
    {
        ...
        bullets: [
            ...
            "有些魔法需要你維持集中力來令到此魔法能繼續有效。如果你對魔法的集中力被打斷，魔法效力亦即中斷。當你要使用另一個需要集中力的魔法時、又或是當你「喪失能力」時，你對你正在集中的魔法便會被打斷。在每一次收傷時，你必需投一次 「生命力挽救骰」（Constitution saving throw) 來決定你是否能維持你的集中力。「測試難度」（DC) 是等於10 或你所受到的傷害的一半，視乎那個數目比較高。"
        ]
    },
    {
        title: "衝跑 Dash",
