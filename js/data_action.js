data_action = [
    ...
    },
    {
        ...
        bullets: [
            ...
            "魔法的目標必定要在魔法的有效範圍內。倘若要鎖定一個目標，你必需有一個跟目標明確的路線。即是說目標不能在完全遮擋之下。",
            "當魔法要使用魔法物料時，如沒有指明會消耗物料，物料是可以重用的。除非物料的成本有被指明，你可以假定那成本沒有太多價值並且能在你的魔法物料袋中拿出來用。",
            "有些魔法需要你維持集中力來令到此魔法能繼續有效。如果你對魔法的集中力被打斷，魔法效力亦即中斷。當你要使用另一個需要集中力的魔法時、又或是當你「喪失能力」時，你對你正在集中的魔法便會被打斷。在每一次受傷時，你必需投一次 「生命力挽救骰」（Constitution saving throw) 來決定你是否能維持你的集中力。「測試難度」（DC) 是等於10 或你所受到的傷害的一半，視乎那個數目比較高。"
        ]
    },
    {
        title: "衝跑 Dash",
